...
int custom_widget_matrix_status_init(struct custom_widget_matrix_status *widget, lv_obj_t *parent) {
    ...
    lv_style_set_bg_color(&button_style, LV_STATE_DEFAULT, lv_color_to1(LV_COLOR_BLACK));
    lv_style_set_bg_color(&button_style, LV_STATE_PRESSED, lv_color_to1(LV_COLOR_WHITE));
    lv_style_set_border_color(&button_style, LV_STATE_DEFAULT, lv_color_to1(LV_COLOR_WHITE));
    lv_style_set_border_width(&button_style, LV_STATE_DEFAULT, 2);
    lv_style_set_border_color(&button_style, LV_STATE_PRESSED, lv_color_to1(LV_COLOR_WHITE));
